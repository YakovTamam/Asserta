        ...
        <div className="tf-shop-control style-2 mb_10">
          <div className="container">
            <div className="row align-items-center">
              ...
              <div className="col-3">
                <div className="tf-control-filter justify-content-end justify-content-xl-between ps-xxl-30">
                  <FilterToggle />
                  <button
                    id="reset-filter"
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-xl-3">
              <div className="canvas-sidebar sidebar-filter canvas-filter right ps-xxl-30">
