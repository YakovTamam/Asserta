...
export default function Products1() {
  ...
  useEffect(() => {
    setFiltered(
      products8.filter((elm) => elm.filterCategories.includes(activeTab))
    );
  }, [activeTab]);

  return (
    <section className="flat-spacing-3 flat-animate-tab product-tablist">
      <div className="container">
        <div className="sect-top align-items-end wow fadeInUp">
          <h2 className="s-title text-capitalize">Best Sellers</h2>
          <ul className="tab-prd">
          ...
          <div className="tab-pane active show" id="ring" role="tabpanel">
            <div className="tf-btn-swiper-item wow fadeInUp">
              ...
              >
                      ...
                      <div className="card_product-wrapper">
                        ...
                        {product.variantType === "notify" && (
                          <a
                            ...
                            className="variant-box stock bg-main link text-white type-sp-2"
                          >
                ...
                <div className="sw-dot-default tf-sw-pagination d-flex d-xxl-none spd20" />
              </Swiper>
              <div className="nav-swiper style-2 nav-prev-swiper d-none d-xxl-flex snbp20">
                <i className="icon-arrow-left" />
              </div>
              <div className="nav-swiper style-2 nav-next-swiper d-none d-xxl-flex snbn20">
