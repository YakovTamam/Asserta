...
export default function Testimonials() {
  return (
    <section
      className="flat-spacing-7 parallax-wrap parallaxie"
      style={{ backgroundImage: 'url("/images/section/bg-1.jpg")' }}
    >
      <div className="container">
        <div className="sect-top wow fadeInUp">
          ...
          <div className="group-btn-slider style-white ">
            <div className="nav-prev-swiper tf-sw-nav snbp234 cursor-pointer">
              <i className="icon-arrow-left" />
            </div>
            <div className="nav-next-swiper tf-sw-nav snbn234 cursor-pointer">
        ...
        >
            ...
            <SwiperSlide className="swiper-slide" key={index}>
              <div className="box_testimonial--V01 hover-img">
                <Link
                  ...
                  className="box_testimonial-image img-style"
                >
                  <Image
                    src={item.image}
                    alt=""
          ...
          <div className="sw-dot-default style-white tf-sw-pagination spd2" />
        </Swiper>
      </div>
    </section>
  );
