      ...
      <div className="flat-spacing pt-0">
        <div className="container">
          <div className="tf-shop-control">
            <div className="tf-control-filter">
              <div className="tf-filter-dropdown">
                <p className="title-filter h5">
                  <span className="text">FILTER</span>
                </p>
                <DropdownFilter allProps={allProps} />
              </div>
            </div>
            <div className="tf-group-layout type-drop">
          ...
          {(allProps.availability !== "All" ||
            ...
            allProps.price !== "All" ||
            allProps.size !== "All") && (
            <div className="meta-filter-shop type-drop">
              ...
              <button
                id="remove-all"
                className="remove-all-filters tf-btn-line"
