  ...
  return (
    <section className="themesFlat">
      <div
        ...
        style={{ backgroundImage: 'url("/images/section/bg-2.jpg")' }}
      >
        <div className="container">
          <div className="sect-top align-items-end wow fadeInUp">
            ...
            <div className="group-btn-slider style-white">
              <div className="nav-prev-swiper tf-sw-nav snbp28">
                <i className="icon-arrow-left" />
              </div>
              <div className="nav-next-swiper tf-sw-nav snbn28">
          ...
          >
            ...
            <div className="sw-dot-default style-white tf-sw-pagination spd28" />
          </Swiper>
        </div>
      </div>
    </section>
